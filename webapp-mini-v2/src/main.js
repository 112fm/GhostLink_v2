import { createScreenRouter } from "./ui/screens.js?v=20260715-miniapp-release-14";
import { apiFetch, configureApiClient, establishMiniAppSession } from "./api/client.js?v=20260715-miniapp-release-14";
import { bootstrapAuthContext } from "./modules/auth.js?v=20260715-miniapp-release-14";
import { createInviteModule } from "./modules/invites.js?v=20260715-miniapp-release-14";
import { createPaymentsModule } from "./modules/payments.js?v=20260715-miniapp-release-14";
import { createDevicesModule } from "./modules/devices.js?v=20260715-miniapp-release-14";
import { createAdminModule } from "./modules/admin.js?v=20260715-miniapp-release-14";
...
function showAppError(router, error) {
  ...
  const content = {
    "not-found": {
      ...
      image: "./assets/mascot/error-404-detective.png?v=20260715-miniapp-release-14",
    },
    unavailable: {
      code: "OFFLINE",
      title: "Сервис временно недоступен",
      text: "Не удалось связаться с GhostLink. Попробуй повторить через несколько секунд.",
      image: "./assets/mascot/error-unavailable-sleep.png?v=20260715-miniapp-release-14",
    },
    maintenance: {
      code: "MAINTENANCE",
      title: "Ведутся технические работы",
      text: "Мы уже чиним связь. Попробуй обновить Mini App немного позже.",
      image: "./assets/mascot/error-maintenance-helmet.png?v=20260715-miniapp-release-14",
    },
    forbidden: {
      code: "403",
